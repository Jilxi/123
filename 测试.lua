...
function Library.new(Library, name)
    ...
    local ElementColorTransparency = 0.3
    ...
    ScriptTitle.Textlignment = Enum.Textlignment.Center
    ...
    function window.Tab(window, name, icon)
        ...
        TabText.TextSize = 14
        TabText.Textlignment = Enum.Textlignment.Left
        ...
        function tab.Section(tab, name, TabVal)
            ...
            Section.BackgroundTransparency = ElementColorTransparency
            ...
            SectionText.Textlignment = Enum.Textlignment.Left
            ...
            function section.Button(section, text, callback)
                ...
                Btn.BackgroundTransparency = ElementColorTransparency
                ...
                Btn.TextSize = 16
                Btn.Textlignment = Enum.Textlignment.Left
            ...
            function section:Label(text)
                ...
                TextLabel.BackgroundTransparency = ElementColorTransparency
                TextLabel.Size = UDim2.new(0, 428, 0, 22)
                TextLabel.Font = Enum.Font.GothamBold
                TextLabel.Text = text
                TextLabel.TextColor3 = TextColor
                TextLabel.TextSize = 14
                TextLabel.Textlignment = Enum.Textlignment.Center
            ...
            function section.Colorpicker(section, text, flag, defaultColor, callback)
                ...
                ColorBtn.BackgroundTransparency = ElementColorTransparency
                ...
                ColorBtn.Textlignment = Enum.Textlignment.Left
            ...
            function section.Toggle(section, text, flag, enabled, callback)
                ...
                ToggleBtn.BackgroundTransparency = ElementColorTransparency
                ...
                ToggleBtn.Textlignment = Enum.Textlignment.Left
                ...
                local funcs = {
                    SetState = function(self, state)
                        ...
                        TweenService:Create(ToggleSwitch, TweenInfo.new(0.2), {
                            ...
                            BackgroundColor3 = (state and Color3.fromRGB(255, 255, 255) or BackgroundColor),
                        }):Play()
            ...
            function section.Keybind(section, text, default, callback)
                ...
                KeybindBtn.BackgroundTransparency = ElementColorTransparency
                ...
                KeybindBtn.Textlignment = Enum.Textlignment.Left
            ...
            function section.Textbox(section, text, flag, default, callback)
                ...
                TextboxBack.BackgroundTransparency = ElementColorTransparency
                ...
                TextboxBack.Textlignment = Enum.Textlignment.Left
            ...
            function section.Slider(section, text, flag, default, min, max, precise, callback)
                ...
                SliderBack.BackgroundTransparency = ElementColorTransparency
                ...
                SliderBack.Textlignment = Enum.Textlignment.Left
            ...
            function section.Dropdown(section, text, flag, options, default, callback)
                ...
                DropdownTop.BackgroundTransparency = ElementColorTransparency
                ...
                DropdownTop.Textlignment = Enum.Textlignment.Left
                ...
                DropdownText.Textlignment = Enum.Textlignment.Left
                ...
                funcs.AddOption = function(self, option)
                    ...
                    Option.BackgroundTransparency = ElementColorTransparency
